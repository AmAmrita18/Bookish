            ...
            <div className=" space-y-6">
              <div className="flex flex-row gap-16">
                <div className="flex flex-row gap-2">
                  ...
                  />
                  <div>
                    <h5 className="text-lg font-medium">Emma Grace</h5>
            ...
            <div className=" space-y-6">
              <div className="flex flex-row gap-16">
                <div className="flex flex-row gap-2">
                  ...
                  />
                  <div>
                    <h5 className="text-lg font-medium">Olivia Rose</h5>
                    <p className="font-extralight text-xs">CEO, ABC Company</p>
                  </div>
                </div>
                <div className="text-yellow flex gap-2 justify-center items-center">
            ...
            <div className=" space-y-6">
              <div className="flex flex-row gap-16">
                <div className="flex flex-row gap-2">
                  ...
                  />
                  <div>
                    <h5 className="text-lg font-medium">Ava Marie</h5>
                    <p className="font-extralight text-xs">CEO, ABC Company</p>
                  </div>
                </div>
                <div className="text-yellow flex gap-2 justify-center items-center">
            ...
            <div className=" space-y-6">
              <div className="flex flex-row gap-16">
                <div className="flex flex-row gap-2">
                  ...
                  />
                  <div>
                    <h5 className="text-lg font-medium">Sophia Joy</h5>
                    <p className="font-extralight text-xs">CEO, ABC Company</p>
                  </div>
                </div>
                <div className="text-yellow flex gap-2 justify-center items-center">
            ...
            <div className=" space-y-6">
              <div className="flex flex-row gap-16">
                <div className="flex flex-row gap-2">
                  ...
                  />
                  <div>
                    <h5 className="text-lg font-medium">Isabella Hope</h5>
                    <p className="font-extralight text-xs">CEO, ABC Company</p>
                  </div>
                </div>
                <div className="text-yellow flex gap-2 justify-center items-center">
