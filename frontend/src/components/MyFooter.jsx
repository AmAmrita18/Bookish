        ...
        <div className="grid w-full grid-cols-2 gap-8 px-6 py-8 md:grid-cols-4">
          <div>
            ...
            <Footer.LinkGroup col>
              ...
              <Footer.Link href="/about" className='text-off-white hover:text-yellow'>About</Footer.Link>
              <Footer.Link href="/shop" className='text-off-white hover:text-yellow'>Browse</Footer.Link>
              <Footer.Link href="/admin/dashboard" className='text-off-white hover:text-yellow'>Sell Your Book</Footer.Link>
            </Footer.LinkGroup>
          </div>
          <div>
