...
const Banner = () => {
  return (
    <div className="px-4 bg-peach-light flex items-center">
      <div className="flex w-full flex-col md:flex-row justify-between items-center gap-12 py-40">
        {/*left side */}
        <div className="md:w-1/2  space-y-8 h-full">
            <h2 className=" text-5xl text-slate font-bold leading-snug text-black">Buy and Sell Your Books <span className="text-slate-dark">for the Best Prices</span></h2>
            ...
            <div>
                ...
                <button className="bg-slate px-6 py-2 font-medium hover:bg-slate-dark transition-all ease-in duration-200 text-white">Search</button>
            </div>
        </div>
