    ...
    <div className="px-4 min-h-screen lg:px-32 bg-yellow flex  items-center">
      <div className="flex w-full flex-col md:flex-row justify-between items-center gap-12 pt-40 pb-20">
        ...
        <div className="md:w-1/2 space-y-10 h-full">
          ...
          <div className="">
            <input type="text" name="search" id="search" placeholder="search a book" className="py-2 px-2 rounded-l-lg outline-none" />
            <button className="bg-blue px-6 py-2 font-medium hover:bg-blue-extra-dark rounded-r-lg transition-all ease-in duration-200 text-white">Search</button>
          </div>
        </div>
